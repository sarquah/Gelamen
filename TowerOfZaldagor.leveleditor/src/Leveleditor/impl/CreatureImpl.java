...
public abstract class CreatureImpl extends EObjectImpl implements Creature {
	 ...
	 * @ordered
	 */
	protected static final int INIT_PLAYER_ACTIONS_EDEFAULT = 1;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__NAME, oldName, name));
	}
	...
	public void setInitHp(int newInitHp) {
		...
		initHp = newInitHp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__INIT_HP, oldInitHp, initHp));
	}
	...
	public void setInitMana(int newInitMana) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__INIT_MANA, oldInitMana, initMana));
	}
	...
	public void setMana(int newMana) {
		...
		mana = newMana;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__MANA, oldMana, mana));
	}
	...
	public void setStrength(int newStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__STRENGTH, oldStrength, strength));
	}
	...
	public void setAgility(int newAgility) {
		...
		agility = newAgility;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__AGILITY, oldAgility, agility));
	}
	...
	public void setCharisma(int newCharisma) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__CHARISMA, oldCharisma, charisma));
	}
	...
	public void setLevel(int newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__LEVEL, oldLevel, level));
	}
	...
	public void setExperience(int newExperience) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__EXPERIENCE, oldExperience, experience));
	}
	...
	public void setGold(int newGold) {
		...
		gold = newGold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__GOLD, oldGold, gold));
	}
	...
	public void setInitPlayerActions(int newInitPlayerActions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__INIT_PLAYER_ACTIONS, oldInitPlayerActions, initPlayerActions));
	}
	...
	public void setResistLightning(int newResistLightning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__RESIST_LIGHTNING, oldResistLightning, resistLightning));
	}
	...
	public void setResistFire(int newResistFire) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__RESIST_FIRE, oldResistFire, resistFire));
	}
	...
	public void setResistPoison(int newResistPoison) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__RESIST_POISON, oldResistPoison, resistPoison));
	}
	...
	public void setResistIce(int newResistIce) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__RESIST_ICE, oldResistIce, resistIce));
	}
	...
	public void setIsMale(boolean newIsMale) {
		...
		isMale = newIsMale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__IS_MALE, oldIsMale, isMale));
	}
	...
	public void setRace(ECreatureRace newRace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__RACE, oldRace, race));
	}
	...
	public void setCreatureClass(ECreatureClass newCreatureClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__CREATURE_CLASS, oldCreatureClass, creatureClass));
	}
	...
	public void setArmor(int newArmor) {
		...
		armor = newArmor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeveleditorPackage.CREATURE__ARMOR, oldArmor, armor));
	}
